...
state_lock = threading.Lock()  # Zaštita pristupa state-u
...
# Watchdog koji šalje stanje svakih 100ms
...
def main():
    ...
    # Pokreni watchdog i receiver u zasebnim threadovima
    ...
    # Pokreni glavnu petlju za joystick
    joystick_loop(ser)
