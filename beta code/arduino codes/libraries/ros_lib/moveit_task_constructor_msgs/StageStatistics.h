...
namespace moveit_task_constructor_msgs
{
  ...
  class StageStatistics : public ros::Msg
  {
    public:
      ...
      typedef float _total_compute_time_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const override
    {
      ...
      *(outbuffer + offset + 3) = (this->num_failed >> (8 * 3)) & 0xFF;
      ...
      offset += serializeAvrFloat64(outbuffer + offset, this->total_compute_time);
      return offset;
    }
    ...
    virtual int deserialize(unsigned char *inbuffer) override
    {
      ...
      offset += sizeof(this->num_failed);
      offset += deserializeAvrFloat64(inbuffer + offset, &(this->total_compute_time));
     return offset;
    }
