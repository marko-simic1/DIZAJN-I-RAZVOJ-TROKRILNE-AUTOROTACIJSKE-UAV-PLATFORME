...
namespace open_manipulator_msgs
{
  ...
  class OpenManipulatorState : public ros::Msg
  {
    public:
      ...
      enum { ACTUATOR_ENABLED =  "ACTUATOR_ENABLED" };
      enum { ACTUATOR_DISABLED =  "ACTUATOR_DISABLED" };
    ...
    virtual const char * getType() override { return "open_manipulator_msgs/OpenManipulatorState"; };
    virtual const char * getMD5() override { return "35c95327a0dcb52791892bac52df33e8"; };
