...
static const char SETDRAWINGTRAJECTORY[] = "open_manipulator_msgs/SetDrawingTrajectory";
  ...
  class SetDrawingTrajectoryRequest : public ros::Msg
  {
    ...
    SetDrawingTrajectoryRequest():
      ...
      param_length(0), st_param(), param(nullptr),
      path_time(0)
    {
    }
    ...
    virtual const char * getType() override { return SETDRAWINGTRAJECTORY; };
    virtual const char * getMD5() override { return "5b1621cd6a6a57a64c9ee8bfb64e3d14"; };
  ...
  class SetDrawingTrajectoryResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return SETDRAWINGTRAJECTORY; };
    virtual const char * getMD5() override { return "2638cc2443b1469b0e9e152083d7128d"; };
