...
namespace open_manipulator_msgs
{
  ...
  class KinematicsPose : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "open_manipulator_msgs/KinematicsPose"; };
    virtual const char * getMD5() override { return "bad8d5def2efabb0336490f8e9f6f2e2"; };
