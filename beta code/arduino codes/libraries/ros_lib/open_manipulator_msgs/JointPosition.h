...
namespace open_manipulator_msgs
{
  ...
  class JointPosition : public ros::Msg
  {
    ...
    JointPosition():
      joint_name_length(0), st_joint_name(), joint_name(nullptr),
    ...
    virtual const char * getType() override { return "open_manipulator_msgs/JointPosition"; };
    virtual const char * getMD5() override { return "b6b6bc3417b5da955b766eb41a6c1698"; };
