...
static const char GETJOINTPOSITION[] = "open_manipulator_msgs/GetJointPosition";
  ...
  class GetJointPositionRequest : public ros::Msg
  {
    ...
    virtual const char * getType() override { return GETJOINTPOSITION; };
    virtual const char * getMD5() override { return "6b02e06b167eb20b51185dc7d0b638aa"; };
  ...
  class GetJointPositionResponse : public ros::Msg
  {
    ...
    virtual const char * getType() override { return GETJOINTPOSITION; };
    virtual const char * getMD5() override { return "e1f1ee99b5e77308297dc4eeedd305d4"; };
